...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="col-md-12">
        <asp:Label ID="Label0" runat="server" Text="Select a Player"></asp:Label>&nbsp;&nbsp;
             ...
             <asp:LinkButton ID="UpdatePlayer" runat="server" Font-Size="Large"
                 OnClick="UpdatePlayer_Click">Update</asp:LinkButton>&nbsp;&nbsp;
             <asp:LinkButton ID="DeletePlayer" runat="server" Font-Size="Large"
                 OnClick="DeletePlayer_Click" CausesValidation="false"
